...
SP.UI.Dialog.prototype = {
    ...
    $1k_0: function($p0) {
        if (this.$S_0) {
            this.$3_0.innerHTML = '<span style=\"height:18px;width:18px;position:relative;display:inline-block;overflow:hidden;\" class=\"s4-clust\"><img src=\"../../arquivos/img/fgimg.png\" style=\"left:-0px !important;top:-676px !important;position:absolute;\" class=\'ms-dlgCloseBtnImg\' /></span>';
            ...
            this.$3_0.innerHTML = '<span style=\"height:18px;width:18px;position:relative;display:inline-block;overflow:hidden;\" class=\"s4-clust\"><img src=\"../../arquivos/img/fgimg.png\" style=\"left:-0px !important;top:-694px !important;position:absolute;\" class=\'ms-dlgCloseBtnImg\' /></span>';
    ...
    $1w_0: function() {ULSTYE:;
        ...
        if (this.$t_0) {
            ...
            this.$5_0.innerHTML = '<span style=\"height:18px;width:18px;position:relative;display:inline-block;overflow:hidden;\" class=\"s4-clust\"><img src=\"../../arquivos/img/fgimg.png\" style=\"left:-0px !important;top:-658px !important;position:absolute;\" class=\'ms-dlgCloseBtnImg\' /></span>';
...
SP.UI.ModalDialog.$1I_1 = function($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7, $p8) {
    ...
    if ($p8 === 1) {
        $v_8.src = '../../arquivos/img/gears_anv4.gif';
    }
    else if (!$p8) {
        $v_8.src = '../../arquivos/img/loadingcirclests16.gif';
    }
    $v_7.appendChild($v_8);
    $v_6.appendChild($v_7);
