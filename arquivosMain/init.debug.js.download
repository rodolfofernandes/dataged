...
{ULSxSy:;
  ...
  iframe.contentWindow.document.location.replace('../arquivos/imgblank.gif');
}
	...
	for (var i=0;i<numElts;i++)
	{
					...
					&& (groupName==childObj.id.slice(4).substr(0,len)) )
		{
			...
			if (fOpen && childObj.id.substr(0,4)=="titl")
			{
				...
				imgObj.src='../arquivos/imgplus.gif';
			}
...
{ULSxSy:;
	...
	{
		sqlDocument.open();
		sqlDocument.write('<html><head><link rel="stylesheet" type="text/css" href="../arquivos/styles/layouts.css"/></head><body><div class="ms-developerdashboard"><table width="100%"><tr><td style="font-weight:bold">');
...
{ULSxSy:;
	...
	_elmBlankTab.innerHTML="<span class=\"ms-ribbontabswitchloading\"><img src=\"../arquivos/imgloadingcirclests16.gif\" alt=\"\"/><span>"+L_Loading_Text+"</span></span>";
