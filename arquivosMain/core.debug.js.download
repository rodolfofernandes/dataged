...
{ULSsa6:;
	...
	{
		displayStr="";
		img.src='../arquivos/imgminus.gif';
	}
	else
	{
		displayStr="none";
		img.src='../arquivos/imgplus.gif';
	}
	oldName=img.name;
	img.name=img.alt;
	img.alt=oldName;
	...
	for(var j=i+1; j<numElts; j++)
	{
		...
		if (displayStyle !="none" &&
			...
			childObj.src !=null)
		{
			if (childObj.src.slice(childObj.src.length - 25)=='../arquivos/imgplus.gif')
			{
				displayStr="none";
			}
			else if (childObj.src.slice(childObj.src.length - 26)=='../arquivos/imgminus.gif')
			{
				displayStr="";
			}
		}
	...
	if (tr !=null)
	{
		...
		if (tr.cells && tr.cells.length > 0)
		{
			...
			if (c.innerHTML=="" && c.width=="1%")
			{
				...
				AddAutoModeTag(c, tr, "../arquivos/imgedititem.gif");
			}
			else if (tr.cells.length > 1)
			{
				c=tr.cells[1];
	...
	if (tr !=null && tr.cells.length > 1)
	{
		...
		if (a !=null)
		{
			...
			if (img !=null && img.tagName=="IMG")
				img.src="../arquivos/imgspinnyrefresh.gif";
		}
	}
	if (window.event)
		window.event.cancelBubble=true;
...
{ULSsa6:;
	...
	if(typeof(div.shown)=="undefined")
	{
		...
		menuImgTag.src="../arquivos/imgecbarw.png";
...
{ULSsa6:;
	...
	if (isTable)
	{
		...
		filterImageCell=titleRow.childNodes[titleRow.childNodes.length - 1];
		var filterArrow=filterImageCell.childNodes[0];
		filterArrow.src="../arquivos/imgmenudark.gif";
		filterArrow.alt=L_OpenMenu_Text;
		filterArrow.style.visibility="visible";
		if (IsElementRtl(filterTable))
		{
...
{ULSsa6:;
	...
	if (j==i - 1)
		strImageUrl="../arquivos/imgFILTEROFFDISABLED.gif";
	else
		strImageUrl="../arquivos/imgFILTEROFF.gif";
	if (i > 0)
	{
	...
	if (chkToggle !=null)
	{
		...
		if (img !=null)
		{
			if (chkToggle.checked)
				img.src='../arquivos/imgcheckall.gif';
			else
				img.src='../arquivos/imgunchecka.gif';
		}
	}
}
...
{ULSsa6:;
	...
	oMaster._wzChkMrkPath="../arquivos/imgChkMrk.gif";
	oMaster._wzMArrPath="../arquivos/imgMArr.gif";
	oMaster._wzMArrPathRtL="../arquivos/imgMArrRtL.gif";
}
...
{ULSsa6:;
	...
	{
		oImg.src="../arquivos/imgblank.gif";
		oImg.alt="";
		oImg.title="";
	}
