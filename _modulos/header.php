...
<div id="site-menu">
	...
	<div class="menu horizontal menu-horizontal">
		<ul class="root static">
			<li class="static"><a class="static menu-item" title="Relatório" href="/sites/demo/_layouts/dataxdoc/settings/report.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/report-24x24.png" alt=""><span class="menu-item-text">Relatório</span></span></a></li><li class="static dynamic-children"><a class="static dynamic-children menu-item" title="Configurações do Site"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/settings-24x24.png" alt=""><span class="menu-item-text">Configurações do Site</span></span></a><ul class="dynamic">
				<li class="dynamic"><a class="dynamic menu-item" href="/sites/demo/_layouts/dataxdoc/settings/users.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/users-24x24.png" alt=""><span class="menu-item-text">Usuários</span></span></a></li><li class="dynamic"><a class="dynamic menu-item" href="/sites/demo/_layouts/dataxdoc/old/settings/managefiles.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/file-cabinet-24x24.png" alt=""><span class="menu-item-text">Locais de Guarda</span></span></a></li><li class="dynamic"><a class="dynamic menu-item" href="/sites/demo/_layouts/dataxdoc/settings/permissions.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/access-24x24.png" alt=""><span class="menu-item-text">Permissões</span></span></a></li><li class="dynamic"><a class="dynamic menu-item" href="/sites/demo/_layouts/dataxdoc/settings/content-types-and-indexers.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/content-type-24x24.png" alt=""><span class="menu-item-text">Tipos Documentais</span></span></a></li><li class="dynamic"><a class="dynamic menu-item" href="/sites/demo/_layouts/dataxdoc/general/general-settings.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/general-settings-icon.png" alt=""><span class="menu-item-text">Geral</span></span></a></li><li class="dynamic"><a class="dynamic menu-item" href="/sites/demo/_layouts/settings.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/configuracao-site.png" alt=""><span class="menu-item-text">Configurações do Site</span></span></a></li>
				...
				<li class="dynamic"><a class="dynamic menu-item" href="/sites/demo/_layouts/dataxdoc/old/my/lastindexeddocuments.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/last-indexed-docs-24x24.png" alt=""><span class="menu-item-text">Meus Últimos Documentos Indexados</span></span></a></li><li class="dynamic"><a class="dynamic menu-item" href="/sites/demo/_layouts/dataxdoc/my/personal-info.aspx"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/personal-info-24x24.png" alt=""><span class="menu-item-text">Meus Dados Pessoais</span></span></a></li><li class="dynamic"><a class="dynamic menu-item" href="../acesso/logout.php"><span class="additional-background"><img class="menu-item-image" src="../../arquivosMain/sign-out-24x24.png" alt=""><span class="menu-item-text">Sair</span></span></a></li>
			</ul></li>
		</ul>
	</div>
</div>
