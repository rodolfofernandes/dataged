...
SP.Ribbon.ListViewWebPartPageComponent.prototype = {
    ...
    $3o_3: function($p0) {
        ...
        $v_0.append('\r\n                <Menu Id=\"Ribbon.List.Settings.EditDefaultForms.Menu\">');
        $v_0.append('\r\n                  <MenuSection Id=\"Ribbon.List.Settings.EditDefaultForms.Menu.Default\" Scrollable=\"false\" DisplayMode=\"Menu16\">\r\n                    <Controls Id=\"Ribbon.List.Settings.EditDefaultForms.Menu.Default.Controls\">');
        $v_0.append('\r\n                    <Button \r\n                        Id=\"Ribbon.List.Settings.EditDefaultForms.Menu.MS.ListFormFetchErrorMessage\"\r\n                        Image16by16=\"../../arquivos/img/edit.gif\"\r\n                        Image32by32=\"../../arquivos/img/placeholder32x32.png\"\r\n                        LabelText=\"' + $p0 + '\"\r\n                    />');
        $v_0.append('\r\n                    </Controls>\r\n                  </MenuSection>');
        $v_0.append('\r\n                </Menu>');
        return $v_0.toString();
    },
...
SP.Ribbon.DocLibWebPartPageComponent.prototype = {
    ...
    $5p_4: function() {ULSMg8:;
        ...
        if (this.canHandleECBCommand('SendToExistingCopies')) {
            ...
            $v_1.append('\' Image16by16=\'../../arquivos/img/existingLocations.gif\'');
            $v_1.append(' LabelText=\'');
        ...
        $v_1.append('\' Image16by16=\'../../arquivos/img/sendOtherLoc.gif\'');
        $v_1.append(' LabelText=\'');
...
SP.Ribbon.WikiPageComponent.$4p_1 = function() {ULSMg8:;
    var $v_0 = new Sys.StringBuilder();
    $v_0.append('\r\n<table style=\'padding:10px;\'>\r\n    <tr>\r\n        <td><img src=\'../../arquivos/img/warning32by32.gif\' alt=\'\' /></td>\r\n        <td>');
...
SP.Ribbon.WikiPageComponent.prototype = {
    ...
    $5H_1: function($p0, $p1, $p2) {
        if (!SP.Ribbon.WikiPageComponent.$P_1) {
            ...
            var $v_0 = '<img src=\"../../arquivos/img/loadingcirclests16.gif\" style=\"vertical-align: middle\" />';
    ...
    $1V_1: function($p0, $p1, $p2) {
        if (!SP.Ribbon.WikiPageComponent.$P_1) {
            ...
            var $v_0 = null;
            var $v_1;
            var $v_2 = '<img src=\"../../arquivos/img/loadingcirclests16.gif\" style=\"vertical-align: middle\" />';
            var $v_3 = false;
            switch ($p0) {
