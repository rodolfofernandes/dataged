...
<!-- saved from url=(0114)edit-user.aspx?key=f7bb361b-a815-4144-bf62-6426fb0fe484 -->
...
<link rel="stylesheet" type="text/css" href="../../arquivosNovoUsuario/page.css">
<link rel="stylesheet" type="text/css" href="../../arquivosNovoUsuario/search.css">
<link rel="stylesheet" type="text/css" href="../../arquivosNovoUsuario/settings-page-1.css">
<link rel="stylesheet" type="text/css" href="../../arquivosNovoUsuario/corev4.css">
    ...
    <script type="text/javascript">
// <![CDATA[
document.write('<script type="text/javascript" src="../../arquivosscripts/jquery.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/jquery-ui.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/load-image.all.min.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/_plugins/jquery-file-upload-9.11.2/js/jquery.fileupload.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/_plugins/jquery-file-upload-9.11.2/js/jquery.iframe-transport.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/_plugins/jquery-file-upload-9.11.2/js/jquery.fileupload-process.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/_plugins/jquery.mask/dist/jquery.mask.min.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/plugins/jquery.blockui/custom/jquery.blockui.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/plugins/prettycheckboxes/compressed.1.1/prettycheckboxes.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/plugins/jquery.watermark/3.1.4/jquery.watermark.min.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/plugins/jquery.maskmoney/3.0.2/jquery.maskmoney.min.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/site.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/_site.js"></' + 'script>');
document.write('<script type="text/javascript" src="../../arquivosscripts/controls.js"></' + 'script>');
...
// ]]>
  ...
  <link type="text/css" href="../../arquivosNovoUsuario/jquery-ui.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="../../arquivosNovoUsuario/jquery.watermark.min.js.download"></script>
    <script type="text/javascript" src="../../arquivosNovoUsuario/jquery.mask.min.js(1).download"></script>
    <script type="text/javascript" src="../../arquivosNovoUsuario/jquery.maskmoney.min.js(1).download"></script>
  ...
  <script type="text/javascript">
    function ValidatePW() {
      var textbox2 = $('[id*=txtPassword]').attr("id");
      var textBox = $('[id*=txtConfirmPassword]').attr("id");
      var myField = new LiveValidation(textBox);
      myField.add(Validate.Confirmation, { match: textbox2 });
    };
    function ValidateEm() {
      var textbox2 = $('[id*=txtEmail]').attr("id");
      var textBox = $('[id*=txtConfirmEmail]').attr("id");
      var myField = new LiveValidation(textBox);
      myField.add(Validate.Confirmation, { match: textbox2 });
    };
...
<form name="Form" method="post" action="alterardadospessoais.php" enctype="multipart/form-data">
...
<script type="text/javascript">
//<![CDATA[
var MSOWebPartPageFormName = 'Form';
...
<script type="text/javascript">
<!--
var L_Menu_BaseUrl="/dataxdoc/_modulos/";
...
<script src="../../arquivosNovoUsuario/ScriptResource(3).axd" type="text/javascript"></script>
...
<script type="text/javascript">
//<![CDATA[
Sys.WebForms.PageRequestManager._initialize('ctl00$ScriptManager', document.getElementById('Form'));
Sys.WebForms.PageRequestManager.getInstance()._updateControls(['tUpdatePanel1','tupLayoutType','fctl00$WebPartAdderUpdatePanel'], ['rblRoles'], ['ctl00$WebPartAdder'], 90);
//]]>
</script>
...
<div id="divReportMenu">
    ...
    <a href="edit-user.aspx?key=f7bb361b-a815-4144-bf62-6426fb0fe484#zz1_menuSettings_SkipLink"><img alt="Skip Navigation Links" src="../../arquivosNovoUsuario/WebResource(2).axd" width="0" height="0" style="border-width:0px;"></a><table id="zz1_menuSettings" class="zz1_menuSettings_2" cellpadding="0" cellspacing="0" border="0">
	<tbody><tr>
		<td onmouseover="Menu_HoverStatic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz1_menuSettingsn0"><table class="SettingsMenu zz1_menuSettings_4" cellpadding="0" cellspacing="0" border="0" width="100%">
			<tbody><tr>
				<td style="white-space:nowrap;"><a class="zz1_menuSettings_1 SettingsMenu zz1_menuSettings_3" href="edit-user.aspx?key=f7bb361b-a815-4144-bf62-6426fb0fe484#" style="border-style:none;font-size:1em;cursor:text;"><img src="../../arquivosNovoUsuario/settings-24x24.png" alt="" style="border-style:none;vertical-align:middle;"></a></td><td style="width:0;"><img src="../../arquivosNovoUsuario/static_arrow.png" alt="Expand " style="border-style:none;vertical-align:middle;"></td>
			</tr>
		</tbody></table></td>
	</tr>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tbody><tr onmouseover="Menu_HoverDynamic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz1_menuSettingsn1">
			<td><table class="SettingsMenuItem zz1_menuSettings_6" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tbody><tr>
					<td style="white-space:nowrap;width:100%;"><a class="zz1_menuSettings_1 SettingsMenuItem zz1_menuSettings_5" href="usuarios.php" style="border-style:none;font-size:1em;"><img src="../../arquivosNovoUsuario/user.png" alt="" style="border-style:none;vertical-align:middle;">Usuários</a></td>
				</tr>
			</tbody></table></td>
		</tr><tr onmouseover="Menu_HoverDynamic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz1_menuSettingsn2">
			<td><table class="SettingsMenuItem zz1_menuSettings_6" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tbody><tr>
					<td style="white-space:nowrap;width:100%;"><a class="zz1_menuSettings_1 SettingsMenuItem zz1_menuSettings_5" href="https://dtc-server01/dataxdoc/_modulos/../../arquivosold/settings/ManageFiles.aspx" style="border-style:none;font-size:1em;"><img src="../../arquivosNovoUsuario/file.png" alt="" style="border-style:none;vertical-align:middle;">Locais de Guarda</a></td>
				</tr>
			</tbody></table></td>
		</tr><tr onmouseover="Menu_HoverDynamic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz1_menuSettingsn3">
			<td><table class="SettingsMenuItem zz1_menuSettings_6" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tbody><tr>
					<td style="white-space:nowrap;width:100%;"><a class="zz1_menuSettings_1 SettingsMenuItem zz1_menuSettings_5" href="https://dtc-server01/dataxdoc/_modulos/../../arquivosold/settings/ManageAccesses.aspx" style="border-style:none;font-size:1em;"><img src="../../arquivosNovoUsuario/access.png" alt="" style="border-style:none;vertical-align:middle;">Permissões</a></td>
				</tr>
			</tbody></table></td>
		</tr><tr onmouseover="Menu_HoverDynamic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz1_menuSettingsn4">
			<td><table class="SettingsMenuItem zz1_menuSettings_6" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tbody><tr>
					<td style="white-space:nowrap;width:100%;"><a class="zz1_menuSettings_1 SettingsMenuItem zz1_menuSettings_5" href="https://dtc-server01/dataxdoc/_modulos/../../arquivosold/settings/ManageContentTypesAndMetadata.aspx" style="border-style:none;font-size:1em;"><img src="../../arquivosNovoUsuario/IconIndexadoresETipoDocumental.png" alt="" style="border-style:none;vertical-align:middle;">Tipos Documentais</a></td>
				</tr>
			</tbody></table></td>
		</tr><tr onmouseover="Menu_HoverDynamic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz1_menuSettingsn5">
			<td><table class="SettingsMenuItem zz1_menuSettings_6" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tbody><tr>
					<td style="white-space:nowrap;width:100%;"><a class="zz1_menuSettings_1 SettingsMenuItem zz1_menuSettings_5" href="https://dtc-server01/dataxdoc/_modulos/../../arquivosgeneral/general-settings.aspx" style="border-style:none;font-size:1em;"><img src="../../arquivosNovoUsuario/general-settings-icon.png" alt="" style="border-style:none;vertical-align:middle;">Configuração Geral</a></td>
				</tr>
			</tbody></table></td>
		</tr>
...
<div id="divWelcomeMenu">
    ...
    <a href="edit-user.aspx?key=f7bb361b-a815-4144-bf62-6426fb0fe484#zz2_menuWelcome_SkipLink"><img alt="Skip Navigation Links" src="../../arquivosNovoUsuario/WebResource(2).axd" width="0" height="0" style="border-width:0px;"></a><table id="zz2_menuWelcome" class="divWelcomeMenu zz2_menuWelcome_2" cellpadding="0" cellspacing="0" border="0">
	<tbody><tr>
		<td onmouseover="Menu_HoverStatic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz2_menuWelcomen0"><table class="WelcomeMenu zz2_menuWelcome_4" cellpadding="0" cellspacing="0" border="0" width="100%">
			<tbody><tr>
				<td style="white-space:nowrap;"><a class="zz2_menuWelcome_1 WelcomeMenu zz2_menuWelcome_3" href="edit-user.aspx?key=f7bb361b-a815-4144-bf62-6426fb0fe484#" style="border-style:none;font-size:1em;cursor:text;">Olá, <?=$_SESSION['user']?></a></td><td style="width:0;"><img src="../../arquivosNovoUsuario/static_arrow.png" alt="Expand Olá, <?=$_SESSION['user']?>" style="border-style:none;vertical-align:middle;"></td>
			</tr>
		</tbody></table></td>
	</tr>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tbody><tr onmouseover="Menu_HoverDynamic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz2_menuWelcomen1">
			<td><table class="WelcomeMenuItem zz2_menuWelcome_6" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tbody><tr>
					<td style="white-space:nowrap;width:100%;"><a class="zz2_menuWelcome_1 WelcomeMenuItem zz2_menuWelcome_5" href="https://dtc-server01/dataxdoc/_modulos/../../arquivosold/my/LastIndexedDocuments.aspx" style="border-style:none;font-size:1em;"><img src="../../arquivosNovoUsuario/lastdocs.png" alt="" style="border-style:none;vertical-align:middle;">Meus Últimos Documentos Indexados</a></td>
				</tr>
			</tbody></table></td>
		</tr><tr onmouseover="Menu_HoverDynamic(this)" onmouseout="Menu_Unhover(this)" onkeyup="Menu_Key(event)" id="zz2_menuWelcomen2">
			<td><table class="WelcomeMenuItem zz2_menuWelcome_6" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tbody><tr>
					<td style="white-space:nowrap;width:100%;"><a class="zz2_menuWelcome_1 WelcomeMenuItem zz2_menuWelcome_5" href="https://dtc-server01/dataxdoc/_modulos/../../arquivosmy/personal-info.aspx" style="border-style:none;font-size:1em;"><img src="../../arquivosNovoUsuario/personalinfo.png" alt="" style="border-style:none;vertical-align:middle;">Meus Dados Pessoais</a></td>
				</tr>
			</tbody></table></td>
  ...
  <div id="form-container">
    <h1>
      <img alt="EDITAR USUÁRIO" src="../../arquivos/img/edit-userheading.png">
     <input type="image" name="close" title="Fechar" src="../../arquivosNovoUsuario/close-button.png" class="close-button" onclick="javascript:history.back()">
    </h1>
      ...
      <div class="content-form">
        <div id="vtab" class="ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-vertical">
          ...
          <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
            <li class="ui-state-default ui-corner-left ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs-1" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true"><a href="edit-user.aspx?key=f7bb361b-a815-4144-bf62-6426fb0fe484#tabs-1" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-1">Dados Pessoais</a></li>
            <li class="ui-state-default ui-corner-left" role="tab" tabindex="-1" aria-controls="tabs-2" aria-labelledby="ui-id-2" aria-selected="false" aria-expanded="false"><a href="edit-user.aspx?key=f7bb361b-a815-4144-bf62-6426fb0fe484#tabs-2" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2">Dados Gerenciais</a></li>
          </ul>

          <!-- Conteúdo | Aba Dados Pessoais -->
          <div id="tabs-1" class="tab ui-tabs-panel ui-widget-content ui-corner-bottom" aria-labelledby="ui-id-1" role="tabpanel" aria-hidden="false" style="display: block;">
            ...
            <div id="divLeftSidePersonalData">
              ...
              <div id="divUploadPhoto">
                <span class="photo-container">
                 <?php  $imgPerfil = consultaImagem($id_usuario); 
                                if(!isset($imgPerfil)) { ?>


                                      <img id="imgUserPhoto" class="photo" src="../../arquivosNovoUsuario/no-photo.png" style="height:121px;width:91px;border-width:0px;">    
                ...
                <div class="fileupload">
                  <span class="fileinput-button">
                    <img id="imgUploadPhoto" src="../../arquivosNovoUsuario/image-upload.png" style="border-width:0px;">
	...
	<tbody><tr>
        <td><input id="rblGender_0" type="radio" name="rblGender" value="f" <?=$feminino;?> ><label for="rblGender_0" class="prettyCheckbox radio list"><span class="holderWrap" style="width: 20px; height: 20px;"></span>Feminino</label></td>
    </tr><tr>
        <td><input id="rblGender_1" type="radio" name="rblGender" value="m" <?=$masculino;?> ><label for="rblGender_1" class="prettyCheckbox radio list"><span class="holderWrap" style="width: 20px; height: 20px;"></span>Masculino</label></td>
    </tr>
</tbody></table>
              </div>
            </div>
            ...
            <?php /* verifica que o usuario esta ativo */
            ...
            <div id="divRightSidePersonalData">
              <div id="divIdentity">
                <span id="userName" class="Label">Usuário:&nbsp;
                                <span id="lblUserName" class="Text"><?=$usuario['nm_login'];?></span></span>
                <span id="alcada" class="Label">

                  <span style="font-family: &#39;Century Gothic&#39;; font-size: 16px; color: #FF660E; margin-left: 60px;">
                  
                  <input id="chkActivated" type="checkbox" name="chkActivated" <?=$checkedAtivo;?> >

                  <label for="chkActivated">Ativo</label></span></span>
              </div>
              ...
              <input name="txtLastName" type="text" value="<?=$usuario['snome'];?>" id="txtLastName" class="htmlInputText220 LeftSpacing5 InlineElement" placeholder="Sobrenome">
              <input name="txtCpf" type="text" value="<?=$usuario['cd_CPF'];?>" id="txtCpf" class="cpf htmlInputText220 TopSpacing20 InlineElement" placeholder="CPF" autocomplete="off">
              <input name="txtDateofBirth" type="text" value="<?=$usuario['dt_nascimento'];?>" id="txtDateofBirth" class="date htmlInputText220 TopSpacing20 LeftSpacing5 InlineElement" placeholder="Data de Nascimento" autocomplete="off">
              <input name="txtEmail" type="text" value="<?=$usuario['ds_email'];?>" id="txtEmail" class="htmlInputText460 TopSpacing20" placeholder="E-mail">
              ...
              <a href="editausuario.php?param=1&id=<?=$id_usuario?>"><input type="button" class="button" value="Redefinir Senha"></input></a>
            </div>
          </div>

          <!-- Conteúdo | Aba Dados Gerenciais -->
          <div id="tabs-2" class="tab tab2 ui-tabs-panel ui-widget-content ui-corner-bottom" aria-labelledby="ui-id-2" role="tabpanel" aria-hidden="true" style="display: none;">
            ...
            <!-- Aba Dados Gerenciais | Conteúdo - Lado Esquerdo -->
            <div id="UpdatePanel1">
                <div id="divLeftSideManagerialData">
                  <div id="divAlcada">
                    <span id="lblSelectAlcada" class="alcada" style="font-family:Century Gothic;font-size:Medium;"></span>

                    <?php /* Verifica o tipo de  acesso do sistema "Administrador = 1, Arquivista = 2, operador = 3*/
                    ...
                    <table id="rblRoles" border="0">
	<tbody><tr>
		<td><input id="rblRoles_0" type="radio" name="rblRoles" value="1" <?= $checkedAcesso[0];?> ><label for="rblRoles_0">Administrador</label></td>
	</tr><tr>
		<td><input id="rblRoles_1" type="radio" name="rblRoles" value="2" <?= $checkedAcesso[1];?> ><label for="rblRoles_1">Arquivista</label></td>
	</tr><tr>
		<td><input id="rblRoles_2" type="radio" name="rblRoles" value="3" <?= $checkedAcesso[2];?> ><label for="rblRoles_2">Operador</label></td>
	</tr>
                ...
                <!-- Aba Dados Gerenciais | Conteúdo - Lado Direito -->
                <div id="divRightSideManagerialData">
                  <div id="divAlcadaInfo">
                    <p class="infobox">
                      <span id="lblAlcadaDescriptionPanel">Administrador – Controle Parcial do Sistema: O Administrador pode incluir, alterar e excluir dados e informações sem prévia autorização. Sua principal atividade é a inclusão de novos usuários, arquivos e metadados.</span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="FormActions">
            ...
            <?php /*Verifica se esta bloqueado == 0 */
            ...
            <a href="desbloquearUsuario.php?id=<?=$id_usuario?>"> <input type="button" name="btnDesbloquear" value="Desbloquear" id="btnDesbloquear" class="button2" <?=$desBloq;?> /></a>
          <input type="submit" name="btnSaveDadosCadastrais" value="Salvar" id="btnSaveDadosCadastrais" class="button2">
        </div>
      </div>
    </div>
  </div>
...
<ie:menuitem id="zz7_MenuItem_ViewAllSiteContents" type="option" iconsrc="../../arquivos/img/allcontent32.png" onmenuclick="STSNavigate2(event,&#39;_layouts/viewlsts.aspx&#39;);" text="View All Site Content" description="View all libraries and lists in this site." menugroupid="300"></ie:menuitem>
...
<ie:menuitem id="zz9_MenuItem_SitePermissions" type="option" iconsrc="../../arquivos/img/Permissions32.png" onmenuclick="STSNavigate2(event,&#39;_layouts/user.aspx&#39;);" text="Site Permissions" description="Give people access to this site." menugroupid="300"></ie:menuitem>
<ie:menuitem id="zz10_MenuItem_Settings" type="option" iconsrc="../../arquivos/img/settingsIcon.png" onmenuclick="STSNavigate2(event,&#39;_layouts/settings.aspx&#39;);" text="Site Settings" description="Access all settings for this site." menugroupid="300"></ie:menuitem>
...
<ie:menuitem id="zz15_ID_Logout" type="option" onmenuclick="STSNavigate2(event,&#39;_layouts/SignOut.aspx&#39;);" text="Sign Out" description="Logout of this site." menugroupid="200"></ie:menuitem>
...
<div id="s4-workspace" class="s4-nosetwidth" style="height: 741px;">  <!-- NOTE: s4-nosetwidth is used when you are setting a fixed page width in css, remove for 100% -->
  ...
  <div id="ctl00_MSO_ContentDiv">
	...
	<div class="menu horizontal menu-horizontal">
		<ul class="root static">
			<li class="static selected"><a class="static selected menu-item" href="https://dtc-server01" accesskey="1"><span class="additional-background"><span class="menu-item-text">Home</span><span class="ms-hidden">Currently selected</span></span></a></li>
		</ul>
	</div>
</div>
	...
	<div class="menu vertical menu-vertical">
		<ul class="root static">
			<li class="static"><a class="static menu-item" href="https://dtc-server01_layouts/viewlsts.aspx?BaseType=1"><span class="additional-background"><span class="menu-item-text">Libraries</span></span></a></li><li class="static"><a class="static menu-item" href="https://dtc-server01_layouts/viewlsts.aspx?BaseType=0"><span class="additional-background"><span class="menu-item-text">Lists</span></span></a></li><li class="static"><a class="static menu-item" href="https://dtc-server01_layouts/viewlsts.aspx?BaseType=0&amp;ListTemplate=108"><span class="additional-background"><span class="menu-item-text">Discussions</span></span></a></li>
		</ul>
	</div>
</div>			
...
<span style="display: none !important;"></span><span style="display: none !important;"></span><span style="display: none !important;"></span><span style="display: none !important;"></span><span style="display: none !important;"></span></form>
